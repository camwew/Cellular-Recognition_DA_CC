...
_C.INPUT.PIXEL_MEAN = [128.0, 128.0, 128.0]
# Values to be used for image normalization
_C.INPUT.PIXEL_STD = [128.0, 128.0, 128.0]
...
_C.MODEL.GLOBAL_FEA_GRL = 1
_C.MODEL.PAFPN_FILLER_GRL = 100
_C.MODEL.NUCLEI_FILLER_GRL = 1.0
_C.MODEL.MRCN_CLASS_LOGITS_GRL = 1.0
...
# ---------------------------------------------------------------------------- #
# Panoptic segmentation options
# ---------------------------------------------------------------------------- #
_C.MODEL.PANOPTIC = CN()
_C.MODEL.PANOPTIC.PS_ON = False
_C.MODEL.PANOPTIC.SEM_PATH = "."
_C.MODEL.PANOPTIC.USE_GN = False
_C.MODEL.PANOPTIC.USE_RELU = True


# ---------------------------------------------------------------------------- #
# Domain adaption options
# ---------------------------------------------------------------------------- #
_C.MODEL.DOMAIN_ADAPTION = CN()
_C.MODEL.DOMAIN_ADAPTION.ENABLE_DA = False
_C.MODEL.DOMAIN_ADAPTION.REVERSE_LABEL = False
_C.MODEL.DOMAIN_ADAPTION.ENABLE_SEMDA = False
_C.MODEL.DOMAIN_ADAPTION.ENABLE_INSDA = False
_C.MODEL.DOMAIN_ADAPTION.ENABLE_IMGDA = False
_C.MODEL.DOMAIN_ADAPTION.USE_GN_SEM = False
_C.MODEL.DOMAIN_ADAPTION.SEM_TYPE = 'RES4'
_C.MODEL.DOMAIN_ADAPTION.LOSS_AVG = False
_C.MODEL.DOMAIN_ADAPTION.MI_MAX = False
_C.MODEL.DOMAIN_ADAPTION.FEATURE_CHANNEL = 32
